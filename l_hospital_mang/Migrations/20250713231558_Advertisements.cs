        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedByEmployeeId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmbulanceRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmbulanceRequests_CAmbulance_Car_CarId",
                        column: x => x.CarId,
                        principalTable: "CAmbulance_Car",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AmbulanceRequests_Employeess_AcceptedByEmployeeId",
                        column: x => x.AcceptedByEmployeeId,
                        principalTable: "Employeess",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AmbulanceRequests_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consulting_reservations_Datess_DateId",
                        column: x => x.DateId,
                        principalTable: "Datess",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmbulanceRequests_AcceptedByEmployeeId",
                table: "AmbulanceRequests",
                column: "AcceptedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AmbulanceRequests_CarId",
                table: "AmbulanceRequests",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_AmbulanceRequests_PatientId",
                table: "AmbulanceRequests",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CAmbulance_Car_CarNumber",
                table: "CAmbulance_Car",
                column: "CarNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Consulting_reservations_DateId",
